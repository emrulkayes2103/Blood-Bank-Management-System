<%@ Page Title="" Language="C#" MasterPageFile="~/App.Master" AutoEventWireup="true" CodeBehind="create.aspx.cs" Inherits="VersityFinalProject.UI.makepostforblood.create" %>
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="col-md-12">
                        <asp:Button ID="PostBtn" runat="server" Text="Post" CssClass="btn btn-primary" OnClick="PostBtn_Click" />
                    </div>
                </div>
            </div>
        </div>
