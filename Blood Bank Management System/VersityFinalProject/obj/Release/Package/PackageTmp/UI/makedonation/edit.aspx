<%@ Page Title="" Language="C#" MasterPageFile="~/App.Master" AutoEventWireup="true" CodeBehind="edit.aspx.cs" Inherits="VersityFinalProject.UI.makedonation.edit" %>
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <div class="row" style="margin-top: 30px;">
                ...
                <div class="col-md-12">
                    <asp:HiddenField runat="server" ID="donationId" />
                    <div class="col-md-6">
            ...
            <div class="row" style="margin-top: 30px;">
                <div class="col-md-12">
                    <div class="col-md-4">
                        <asp:Button runat="server" ID="btnMakeDonation" CssClass="btn btn-primary" Text="Update Donation" OnClick="btnMakeDonation_OnClick" />
                    </div>
                    <div class="col-md-4">
                    </div>
