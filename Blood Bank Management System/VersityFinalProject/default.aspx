    ...
    <section class="no-margin" id="main-slider">
        <div class="carousel slide">
            ...
            <div class="carousel-inner">
                        ...
                        <div class="row slide-margin">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h1 class="animation animated-item-1" style="color: black">Donate blood , Save life.</h1>
                                    <h2 class="animation animated-item-2" style="color: black"></h2>
                                </div>
                            </div>
                ...
                <div style="background-image: url(/sitecontent/images/banner2.jpg); height: 400px;" class="item">
                    <div class="container">
                        <div class="row slide-margin">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h1 style="color: black" class="animation animated-item-1">Share a little, care a little – Donate Blood</h1>
                                    <h2 style="color: black" class="animation animated-item-2"></h2>
                ...
                <div style="background-image: url(/sitecontent/images/tut.jpg); height: 400px;" class="item">
                    <div class="container">
                        <div class="row slide-margin">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h1 style="color: black" class="animation animated-item-1">Tears of a mother cannot save her Child, But your Blood can.</h1>
                                    <h2 style="color: black" class="animation animated-item-2"></h2>
                                    <%-- <a href="#" class="btn-slide animation animated-item-3">Read More</a>--%>
                                </div>
                            </div>
